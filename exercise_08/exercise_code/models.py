...
class Autoencoder(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        lr = self.hparams["lr"]
        optim = torch.optim.Adam(list(self.encoder.parameters())+list(self.decoder.parameters()), lr)
...
class Classifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        lr = self.hparams["lr"]
        optim = torch.optim.Adam(list(self.encoder.parameters())+list(self.model.parameters()), lr)
